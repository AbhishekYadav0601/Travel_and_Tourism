...
<body>
  ...
  <div class="container">
   <h1 class="mt-4 mb-3">Show All Hotel
      <small>Indai</small>
    </h1>
 ...
 <%
    ...
    <P> Hotel Name:-<%=rs.getString("hotel_name")%></P><br>
   <p>  City Name:- <%=rs.getString("city_name")%></p><br>
     <p> AC Cost:- <%=rs.getString("ac_cost")%><p><br>
     <p> Hotel Price:- <%=rs.getString("hotel_cost")%></p><br>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="Bookhotel" method="post">
    <div class="container">
      <h1>Book Package</h1>
      <hr>
      <label for="placename"><b>Hotel Name</b></label>
      <input type="text" placeholder="Enter place name" name="hotelname" required>

      <label for="psw"><b>Customer Name</b></label>
      <input type="text" placeholder="Enter Customer" name="customername" required>
      <label for="psw"><b>Hotel Price</b></label>
      <input type="text" placeholder="Enter package price" name="hotelprice" required>
